...
public class BalancePageController implements Initializable {
    ...
    @FXML
    public void WithdrawMoney(ActionEvent event) throws SQLException, ClassNotFoundException {
        try {
    ...
    @FXML
    public void Deposit(ActionEvent event) throws SQLException, ClassNotFoundException {
        try {
    ...
    @FXML
    public void TransferMoney(ActionEvent event) throws SQLException, ClassNotFoundException {
        try {
